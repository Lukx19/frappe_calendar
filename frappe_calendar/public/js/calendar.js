...
// Modified by Lukas Jelinek lukx19@gmail.com
...
frappe.views.CalendarView = class CalendarView extends frappe.views.ListView {
	...
	get required_libs() {
		return [
			'assets/frappe_calendar/css/fullcalendar.min.css',
			// 'assets/frappe_calendar/js/fullcalendar.min.js',
			'assets/frappe_calendar/js/locale-all.js'
		];
	}
};
...
frappe.views.Calendar = Class.extend({
	...
	make: function () {
		console.log("make function in calendar")
